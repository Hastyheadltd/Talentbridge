...
export default function SignUp() {
  ...
  return (
    <div className='max-w-[1244px] mx-auto mt-[30px] flex flex-col justify-center'>
    <form onSubmit={handleSignup} className="  pb-3 mx-auto flex flex-col items-center justify-center">
        <h1 className='py-3 text-[20px] font-semibold text-primary'>Sign Up As Hiring Company</h1>
                 ...
                 <div className=" mt-7">
                     <button type="submit" 
                     className="bg-primary text-white text-[14px] lg:text-[16px] lg:py-[15px] py-[10px] w-[440px] rounded hover:bg-blue-700 mx-auto h-[43px] lg:h-[56px]" disabled={loading}
                     >
