            ...
            if (code) {
                try {
                    ...
                    const response = await axios.post(
                        `${process.env.NEXT_PUBLIC_BASE_URL}/users/linkedin-auth-freelancer`,
                        { code }
                    );
    ...
    return (
        <div>
            <button
                ...
                className='flex gap-3 justify-center items-center bg-white w-full rounded-full px-8 py-3'
                disabled={loading}
            >
